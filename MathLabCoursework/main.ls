...
{io,JQ,tempConv,_,TM,move,__,udc,katex} = require "./headers.js"
...
JQ.get "test.html", (doc) ->
	...
	ChangeImageRefHTML = (RefOb) ->
		...
		g = (x,i)->
			...
			CENTER = m "span",(style:("text-align":"center")),temp
		...
		FindEqu = (name) ->
			...
			# 			return I
			# console.log "Couldnt Find equation Reference"
		...
		FindImage = (name) ->
			for I from 0 to (RefOb.FigRef.length-1)
				if RefOb.FigRef[I].attrs.caption == name
					return I
			console.log "Couldnt Find Image Reference"
