...
(function(){
  var ref$, io, JQ, tempConv, _, TM, move, __, udc, katex, Chart, reg, Calculations, ChartArray, log, CreateArray, SetValArray, ElementPointers, signals, CreateSimpleChart, config;
  ...
  signals = {};
  signals.load = false;
  CreateSimpleChart = function(data, options){
    var f;
    f = function(element){
      var ctx, NeWChart;
  ...
  JQ.get("test.html", function(doc){
    ...
    ChangeImageRefHTML = function(RefOb){
      ...
      Cinsert = function(x){
        var child, name, con, chart;
        child = x.children[0];
        name = __.each(ChartArray, function(x, i){
          if (x.name = child) {
            return x;
          }
        });
